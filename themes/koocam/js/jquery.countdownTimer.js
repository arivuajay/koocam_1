...
(function ($) {
    ...
    function html($this, content) {
        ...
        if(parseInt(myarr[0]) == 0 && parseInt(myarr[1]) < 2){
            $('#time-alert').removeClass('hide');
        }
        var processedContent = '<div class="hour">  Hour  <br/>  <span>'+myarr[0]+'</span></div><div class="hour">  Min  <br/>  <span>'+myarr[1]+'</span></div><div class="hour"> Sec  <br/> <span>  '+myarr[2]+'</span></div>';
