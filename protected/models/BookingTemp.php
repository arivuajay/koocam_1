 ...
 * @property string $user_return_status
...
class BookingTemp extends RActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('created_at, modified_at, temp_cam_id, temp_book_session, temp_book_is_extra, temp_book_user_id, user_id, tutor_id, status, progress_status, user_return_status', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('temp_id, temp_guid, temp_key, temp_value, created_at, modified_at, progress_status, user_return_status', 'safe', 'on' => 'search'),
        );
    }
