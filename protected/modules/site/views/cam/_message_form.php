            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    $form = $this->beginWidget('CActiveForm', array(
                        'id' => 'message-form',
                        'action' => $this->createUrl('/site/cam/sendmessage'),
                    ...
                    <div class = "form-group form-control-material static hide">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <?php echo $form->labelEx($message, 'cam_id'); ?>
                            <?php echo $form->hiddenField($message, 'cam_id', array('class' => 'form-control', 'rows' => 3, 'cols' => 50, 'value' => $model->cam_id)); ?>
                            <?php echo $form->error($message, 'cam_id'); ?>
                        </div>
                    </div>
